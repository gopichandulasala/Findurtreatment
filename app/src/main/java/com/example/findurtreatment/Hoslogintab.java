...
public class Hoslogintab extends Fragment {
        TextView tv;
        float v = 0;
        EditText email, pass;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            ViewGroup root = (ViewGroup) inflater.inflate(R.layout.haslogintab, container, false);
        ...
        private void reload() {
            Intent intent = new Intent(getActivity(), hoshome.class);
